...
export default function Cursos() {
  ...
  return (
    <main>
      <Navbar />
      <section className=" max-w-7xl w-[90%] lg:w-full mx-auto  overflow-hidden pt-[180px] ">
        <h2 className="text-5xl	 font-bold text-center">Cursos abiertos</h2>
...
const Card = ({
  ...
  return (
    <section>
      <img
        className={twMerge(
          "h-[400px] w-full object-cover object-top rounded-[40px]",
          className
        )}
...
const EmptyCard = ({
  ...
  return (
    <section className="mt-20 bg-dark flex flex-col justify-center items-center rounded-[40px] text-center px-10">
      <h3 className="text-white text-3xl font-semibold mt-6">
        Si el curso que buscas no está aquí, escríbenos
      </h3>
      <p className="text-[#C4C4C4] mt-4 text-2xl font-extralight">
        Trabajamos con cursos personalizados a horarios flexibles.
      </p>
      <button className="flex group mt-12">
